...
public class InputConstants {
    ...
    public static InputConstants.Key getKey(KeyEvent p_427399_) {
        return p_427399_.key() == -1
            ? InputConstants.Type.SCANCODE.getOrCreate(p_427399_.scancode())
            : InputConstants.Type.KEYSYM.getOrCreate(p_427399_.key());
    }
    ...
    public static boolean isKeyDown(Window p_424838_, int p_84832_) {
        return GLFW.glfwGetKey(p_424838_.handle(), p_84832_) == 1;
    }

    public static void setupKeyboardCallbacks(Window p_430733_, GLFWKeyCallbackI p_84846_, GLFWCharModsCallbackI p_84847_) {
        GLFW.glfwSetKeyCallback(p_430733_.handle(), p_84846_);
        GLFW.glfwSetCharModsCallback(p_430733_.handle(), p_84847_);
    }

    public static void setupMouseCallbacks(
        Window p_422947_, GLFWCursorPosCallbackI p_84840_, GLFWMouseButtonCallbackI p_84841_, GLFWScrollCallbackI p_84842_, GLFWDropCallbackI p_84843_
    ) {
        GLFW.glfwSetCursorPosCallback(p_422947_.handle(), p_84840_);
        GLFW.glfwSetMouseButtonCallback(p_422947_.handle(), p_84841_);
        GLFW.glfwSetScrollCallback(p_422947_.handle(), p_84842_);
        GLFW.glfwSetDropCallback(p_422947_.handle(), p_84843_);
    }

    public static void grabOrReleaseMouse(Window p_423996_, int p_84835_, double p_84836_, double p_84837_) {
        GLFW.glfwSetCursorPos(p_423996_.handle(), p_84836_, p_84837_);
        GLFW.glfwSetInputMode(p_423996_.handle(), 208897, p_84835_);
    }
    ...
    public static void updateRawMouseInput(Window p_429900_, boolean p_84850_) {
        if (isRawMouseInputSupported()) {
            GLFW.glfwSetInputMode(p_429900_.handle(), GLFW_RAW_MOUSE_MOTION, p_84850_ ? 1 : 0);
        }
    }
    ...
    public static final class Key {
        ...
        Key(String p_84860_, InputConstants.Type p_84861_, int p_84862_) {
            ...
            this.type = p_84861_;
            this.value = p_84862_;
            this.displayName = Suppliers.memoize(() -> p_84861_.displayTextSupplier.apply(p_84862_, p_84860_));
