...
public class SalmonModel extends EntityModel<SalmonRenderState> {
    ...
    public SalmonModel(ModelPart p_454911_) {
        super(p_454911_);
        this.bodyBack = p_454911_.getChild("body_back");
    }
    ...
    public void setupAnim(SalmonRenderState p_456525_) {
        super.setupAnim(p_456525_);
        float f = 1.0F;
        float f1 = 1.0F;
        if (!p_456525_.isInWater) {
            f = 1.3F;
            f1 = 1.7F;
        }

        this.bodyBack.yRot = -f * 0.25F * Mth.sin(f1 * 0.6F * p_456525_.ageInTicks);
    }
}