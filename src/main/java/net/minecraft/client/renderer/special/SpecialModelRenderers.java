...
public class SpecialModelRenderers {
    ...
    private static final Map<Block, SpecialModelRenderer.Unbaked> STATIC_BLOCK_MAPPING = ImmutableMap.<Block, SpecialModelRenderer.Unbaked>builder()
        ...
        .put(Blocks.COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.UNAFFECTED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.EXPOSED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.EXPOSED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.WEATHERED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.WEATHERED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.OXIDIZED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.WAXED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.UNAFFECTED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.EXPOSED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.WEATHERED, CopperGolemStatueBlock.Pose.STANDING))
        .put(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatheringCopper.WeatherState.OXIDIZED, CopperGolemStatueBlock.Pose.STANDING))
    ...
    public static Map<Block, SpecialModelRenderer<?>> createBlockRenderers(SpecialModelRenderer.BakingContext p_431302_) {
        ...
        map.forEach((p_421033_, p_421034_) -> {
            SpecialModelRenderer<?> specialmodelrenderer = p_421034_.bake(p_431302_);
            if (specialmodelrenderer != null) {
                builder.put(p_421033_, specialmodelrenderer);
            }
        });
