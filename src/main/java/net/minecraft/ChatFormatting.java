...
public enum ChatFormatting implements StringRepresentable {
    ...
    private ChatFormatting(final String p_126627_, final @Nullable char p_126628_, final int p_126629_, final Integer p_126630_) {
    ...
    private ChatFormatting(final String p_126640_, final char p_126641_, final @Nullable boolean p_126642_, final int p_126643_, final Integer p_126644_) {
        this.name = p_126640_;
        this.code = p_126641_;
