...
public class GsonHelper {
    ...
    public static @Nullable String getAsString(JsonObject p_13852_, String p_13853_, @Nullable String p_13854_) {
    ...
    @Contract("_,_,!null->!null;_,_,null->_")
    public static @Nullable Holder<Item> getAsItem(JsonObject p_13910_, String p_13911_, @Nullable Holder<Item> p_300930_) {
    ...
    @Contract("_,_,!null->!null;_,_,null->_")
    public static @Nullable JsonObject getAsJsonObject(JsonObject p_13842_, String p_13843_, @Nullable JsonObject p_13844_) {
    ...
    @Contract("_,_,!null->!null;_,_,null->_")
    public static @Nullable JsonArray getAsJsonArray(JsonObject p_13833_, String p_13834_, @Nullable JsonArray p_13835_) {
    ...
    public static <T> @Nullable T getAsObject(
        JsonObject p_13846_, String p_13847_, @Nullable T p_13848_, JsonDeserializationContext p_13849_, Class<? extends T> p_13850_
    ) {
    ...
    public static <T> T fromJson(Gson p_13777_, Reader p_13778_, Class<T> p_13779_) {
        try {
            JsonReader jsonreader = new JsonReader(p_13778_);
            jsonreader.setStrictness(Strictness.STRICT);
            T t = p_13777_.getAdapter(p_13779_).read(jsonreader);
            if (t == null) {
    ...
    public static <T> @Nullable T fromNullableJson(Gson p_13781_, Reader p_13782_, TypeToken<T> p_408949_) {
        try {
            JsonReader jsonreader = new JsonReader(p_13782_);
            jsonreader.setStrictness(Strictness.STRICT);
            return p_13781_.getAdapter(p_408949_).read(jsonreader);
        } catch (IOException ioexception) {
            throw new JsonParseException(ioexception);
        }
    }
    ...
    public static <T> T fromJson(Gson p_13768_, Reader p_13769_, TypeToken<T> p_13770_) {
        T t = fromNullableJson(p_13768_, p_13769_, p_13770_);
        if (t == null) {
            throw new JsonParseException("JSON data was null or empty");
        } else {
            return t;
    ...
    public static <T> @Nullable T fromNullableJson(Gson p_13786_, String p_13787_, TypeToken<T> p_13788_) {
        return fromNullableJson(p_13786_, new StringReader(p_13787_), p_13788_);
    }

    public static <T> T fromJson(Gson p_13795_, String p_13796_, Class<T> p_13797_) {
        return fromJson(p_13795_, new StringReader(p_13796_), p_13797_);
    }

    public static JsonObject parse(String p_13865_) {
        return parse(new StringReader(p_13865_));
    }

    public static JsonObject parse(Reader p_13860_) {
        return fromJson(GSON, p_13860_, JsonObject.class);
    }
    ...
    public static JsonArray parseArray(Reader p_144766_) {
        return fromJson(GSON, p_144766_, JsonArray.class);
    }
    ...
    public static boolean encodesLongerThan(JsonElement p_391481_, int p_394594_) {
        try {
            Streams.write(p_391481_, new JsonWriter(Streams.writerForAppendable(new GsonHelper.CountedAppendable(p_394594_))));
            return false;
    ...
    static class CountedAppendable implements Appendable {
        ...
        public CountedAppendable(int p_391252_) {
            this.limit = p_391252_;
        }

        private Appendable accountChars(int p_394535_) {
            this.totalCount += p_394535_;
        ...
        @Override
        public Appendable append(CharSequence p_395937_) {
            return this.accountChars(p_395937_.length());
        }

        @Override
        public Appendable append(CharSequence p_396252_, int p_394402_, int p_391661_) {
            return this.accountChars(p_391661_ - p_394402_);
        }

        @Override
        public Appendable append(char p_396334_) {
