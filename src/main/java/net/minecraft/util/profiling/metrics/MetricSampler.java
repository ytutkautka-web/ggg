...
public class MetricSampler {
    ...
    protected MetricSampler(
        String p_145996_, MetricCategory p_145997_, DoubleSupplier p_145998_, @Nullable Runnable p_145999_, MetricSampler.@Nullable ThresholdTest p_146000_
    ) {
        this.name = p_145996_;
    ...
    public static class ValueIncreasedByPercentage implements MetricSampler.ThresholdTest {
        ...
        public boolean test(double p_146066_) {
            ...
            if (this.previousValue != Double.MIN_VALUE && !(p_146066_ <= this.previousValue)) {
                flag = (p_146066_ - this.previousValue) / this.previousValue >= this.percentageIncreaseThreshold;
            } else {
                flag = false;
            }
