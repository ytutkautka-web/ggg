...
public class ArmorStand extends LivingEntity {
    ...
    private static final Predicate<Entity> RIDABLE_MINECARTS = p_449678_ -> p_449678_ instanceof AbstractMinecart abstractminecart && abstractminecart.isRideable();
    ...
    public boolean hurtServer(ServerLevel p_362531_, DamageSource p_364009_, float p_366450_) {
        if (this.isRemoved()) {
            return false;
        } else if (!p_362531_.getGameRules().get(GameRules.MOB_GRIEFING) && p_364009_.getEntity() instanceof Mob) {
            return false;
    ...
    @Override
    protected @Nullable SoundEvent getHurtSound(DamageSource p_31636_) {
