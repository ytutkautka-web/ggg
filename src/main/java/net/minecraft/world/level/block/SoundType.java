...
public class SoundType {
    ...
    public static final SoundType COPPER_GOLEM_STATUE = new SoundType(
        1.0F, 1.0F, SoundEvents.COPPER_GOLEM_STATUE_BREAK, SoundEvents.COPPER_GOLEM_STATUE_STEP, SoundEvents.COPPER_GOLEM_STATUE_PLACE, SoundEvents.COPPER_GOLEM_STATUE_HIT, SoundEvents.COPPER_GOLEM_STATUE_FALL
    );
