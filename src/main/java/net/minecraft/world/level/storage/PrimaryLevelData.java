...
public class PrimaryLevelData implements ServerLevelData, WorldData {
    ...
    private PrimaryLevelData(
        ...
        boolean p_278109_,
        LevelData.RespawnData p_422382_,
        long p_277414_,
        long p_277635_,
        int p_277672_,
        int p_277714_,
        ...
        boolean p_277749_,
        boolean p_278004_,
        Optional<WorldBorder.Settings> p_430528_,
        int p_277595_,
        int p_277794_,
        ...
        this.legacyWorldBorderSettings = p_430528_;
    ...
    public static <T> PrimaryLevelData parse(
        ...
        return new PrimaryLevelData(
            ...
            WorldBorder.Settings.CODEC.parse(p_78531_.get("world_border").orElseEmptyMap()).result(),
    ...
    private void setTagData(RegistryAccess p_78546_, CompoundTag p_78547_, @Nullable CompoundTag p_78548_) {
        ...
        p_78547_.store("spawn", LevelData.RespawnData.CODEC, this.respawnData);
        ...
        this.legacyWorldBorderSettings.ifPresent(p_422262_ -> p_78547_.store("world_border", WorldBorder.Settings.CODEC, p_422262_));
        ...
        p_78547_.store("game_rules", GameRules.codec(this.enabledFeatures()), this.settings.gameRules());
    ...
    @Override
    public void setSpawn(LevelData.RespawnData p_425583_) {
        this.respawnData = p_425583_;
    }
    ...
    @Override
    public void setLegacyWorldBorderSettings(Optional<WorldBorder.Settings> p_423448_) {
        this.legacyWorldBorderSettings = p_423448_;
    }
