...
public class VanillaItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
    public VanillaItemTagsProvider(PackOutput p_275657_, CompletableFuture<HolderLookup.Provider> p_275712_) {
        super(p_275657_, Registries.ITEM, p_275712_, p_405065_ -> p_405065_.builtInRegistryHolder().key());
    }
    ...
    protected void addTags(HolderLookup.Provider p_255639_) {
        (new BlockItemTagsProvider() {
            ...
            protected TagAppender<Block, Block> tag(TagKey<Block> p_409856_, TagKey<Item> p_406371_) {
                return new VanillaItemTagsProvider.BlockToItemConverter(VanillaItemTagsProvider.this.tag(p_406371_));
            }
        }).run();
        ...
        this.tag(ItemTags.CLUSTER_MAX_HARVESTABLES)
            .add(Items.DIAMOND_PICKAXE, Items.GOLDEN_PICKAXE, Items.IRON_PICKAXE, Items.NETHERITE_PICKAXE, Items.STONE_PICKAXE, Items.WOODEN_PICKAXE, Items.COPPER_PICKAXE);
        ...
        this.tag(ItemTags.LEG_ARMOR)
            .add(Items.LEATHER_LEGGINGS, Items.COPPER_LEGGINGS, Items.CHAINMAIL_LEGGINGS, Items.GOLDEN_LEGGINGS, Items.IRON_LEGGINGS, Items.DIAMOND_LEGGINGS, Items.NETHERITE_LEGGINGS);
        this.tag(ItemTags.CHEST_ARMOR)
            .add(Items.LEATHER_CHESTPLATE, Items.COPPER_CHESTPLATE, Items.CHAINMAIL_CHESTPLATE, Items.GOLDEN_CHESTPLATE, Items.IRON_CHESTPLATE, Items.DIAMOND_CHESTPLATE, Items.NETHERITE_CHESTPLATE);
        this.tag(ItemTags.HEAD_ARMOR)
            .add(Items.LEATHER_HELMET, Items.COPPER_HELMET, Items.CHAINMAIL_HELMET, Items.GOLDEN_HELMET, Items.IRON_HELMET, Items.DIAMOND_HELMET, Items.NETHERITE_HELMET, Items.TURTLE_HELMET);
        ...
        this.tag(ItemTags.TRIM_MATERIALS)
            .addAll(
                p_255639_.lookupOrThrow(Registries.ITEM)
                    .listElements()
                    .filter(p_389730_ -> p_389730_.value().components().has(DataComponents.PROVIDES_TRIM_MATERIAL))
                    .sorted(Comparator.comparing(p_448742_ -> p_448742_.key().identifier()))
    ...
    static class BlockToItemConverter implements TagAppender<Block, Block> {
        ...
        public BlockToItemConverter(TagAppender<Item, Item> p_410003_) {
            this.itemAppender = p_410003_;
        }

        public TagAppender<Block, Block> add(Block p_407225_) {
            this.itemAppender.add(Objects.requireNonNull(p_407225_.asItem()));
            return this;
        }

        public TagAppender<Block, Block> addOptional(Block p_410435_) {
            this.itemAppender.addOptional(Objects.requireNonNull(p_410435_.asItem()));
            return this;
        }

        private static TagKey<Item> blockTagToItemTag(TagKey<Block> p_410664_) {
            return TagKey.create(Registries.ITEM, p_410664_.location());
        }

        @Override
        public TagAppender<Block, Block> addTag(TagKey<Block> p_407023_) {
            this.itemAppender.addTag(blockTagToItemTag(p_407023_));
            return this;
        }

        @Override
        public TagAppender<Block, Block> addOptionalTag(TagKey<Block> p_407315_) {
            this.itemAppender.addOptionalTag(blockTagToItemTag(p_407315_));
            return this;
        }
    }
}