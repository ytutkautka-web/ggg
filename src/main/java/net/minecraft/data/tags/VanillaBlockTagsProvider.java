    ...
    protected void addTags(HolderLookup.Provider p_255662_) {
        (new BlockItemTagsProvider() {
            ...
            protected TagAppender<Block, Block> tag(TagKey<Block> p_406922_, TagKey<Item> p_408417_) {
                return VanillaBlockTagsProvider.this.tag(p_406922_);
            }
        }).run();
        ...
        this.tag(BlockTags.REPLACEABLE)
            .addAll(
                p_255662_.lookupOrThrow(Registries.BLOCK).listElements().map(Holder.Reference::value).filter(p_358469_ -> p_358469_.defaultBlockState().canBeReplaced())
            );
