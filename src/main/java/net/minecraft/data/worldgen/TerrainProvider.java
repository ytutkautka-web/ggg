...
public class TerrainProvider {
    ...
    private static final BoundedFloatFunction<Float> AMPLIFIED_OFFSET = BoundedFloatFunction.createUnlimited(p_236651_ -> p_236651_ < 0.0F ? p_236651_ : p_236651_ * 2.0F);
    ...
    public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> overworldOffset(I p_430861_, I p_430822_, I p_430563_, boolean p_236639_) {
        ...
        CubicSpline<C, I> cubicspline1 = buildErosionOffsetSpline(p_430822_, p_430563_, -0.1F, 0.03F, 0.1F, 0.1F, 0.01F, -0.03F, false, false, boundedfloatfunction);
    ...
    public static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> overworldJaggedness(I p_423212_, I p_422424_, I p_430698_, I p_429031_, boolean p_236647_) {
    ...
    private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> buildWeirdnessJaggednessSpline(I p_422338_, float p_236588_, BoundedFloatFunction<Float> p_429601_) {
    ...
    private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> getErosionFactor(
        ...
        if (p_236627_) {
            ...
            CubicSpline<C, I> cubicspline2 = CubicSpline.<C, I>builder(p_425688_, p_423625_)
            ...
            CubicSpline<C, I> cubicspline3 = CubicSpline.<C, I>builder(p_425688_, p_423625_)
    ...
    private static <C, I extends BoundedFloatFunction<C>> CubicSpline<C, I> ridgeSpline(
        ...
        float p_236583_,
        float p_236584_,
        BoundedFloatFunction<Float> p_423510_
    ) {
