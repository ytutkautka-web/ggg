...
public class BiomeDefaultFeatures {
    ...
    public static void addBushes(BiomeGenerationSettings.Builder p_394630_) {
        p_394630_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_BUSH);
    }
    ...
    public static void addOtherBirchTrees(BiomeGenerationSettings.Builder p_126845_) {
        p_126845_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.TREES_BIRCH_AND_OAK_LEAF_LITTER);
    }
    ...
    public static void addBirchForestFlowers(BiomeGenerationSettings.Builder p_397763_) {
        p_397763_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.WILDFLOWERS_BIRCH_FOREST);
    }
    ...
    public static void addBadlandGrass(BiomeGenerationSettings.Builder p_126705_) {
        ...
        p_126705_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DRY_GRASS_BADLANDS);
    ...
    public static void addDesertVegetation(BiomeGenerationSettings.Builder p_126717_) {
        p_126717_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_DRY_GRASS_DESERT);
    ...
    public static void addMeadowVegetation(BiomeGenerationSettings.Builder p_194719_) {
        p_194719_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_GRASS_MEADOW);
        ...
        p_194719_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.WILDFLOWERS_MEADOW);
    }
    ...
    public static void addDefaultExtraVegetation(BiomeGenerationSettings.Builder p_126746_, boolean p_396063_) {
        p_126746_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
        if (p_396063_) {
            addNearWaterVegetation(p_126746_);
        }
    }

    public static void addNearWaterVegetation(BiomeGenerationSettings.Builder p_428019_) {
        p_428019_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
        p_428019_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER);
    }

    public static void addLeafLitterPatch(BiomeGenerationSettings.Builder p_391536_) {
        p_391536_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_LEAF_LITTER);
    }
    ...
    public static void addBadlandExtraVegetation(BiomeGenerationSettings.Builder p_126748_) {
        ...
        p_126748_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER);
    }
    ...
    public static void addSwampExtraVegetation(BiomeGenerationSettings.Builder p_126754_) {
        ...
        p_126754_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_SWAMP);
        p_126754_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER_SWAMP);
    }

    public static void addMangroveSwampExtraVegetation(BiomeGenerationSettings.Builder p_395125_) {
        p_395125_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
        p_395125_.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_FIREFLY_BUSH_NEAR_WATER);
    }
    ...
    public static void farmAnimals(MobSpawnSettings.Builder p_126735_) {
        p_126735_.addSpawn(MobCategory.CREATURE, 12, new MobSpawnSettings.SpawnerData(EntityType.SHEEP, 4, 4));
        p_126735_.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.PIG, 4, 4));
        p_126735_.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.CHICKEN, 4, 4));
        p_126735_.addSpawn(MobCategory.CREATURE, 8, new MobSpawnSettings.SpawnerData(EntityType.COW, 4, 4));
    }

    public static void caveSpawns(MobSpawnSettings.Builder p_176860_) {
        p_176860_.addSpawn(MobCategory.AMBIENT, 10, new MobSpawnSettings.SpawnerData(EntityType.BAT, 8, 8));
        p_176860_.addSpawn(MobCategory.UNDERGROUND_WATER_CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.GLOW_SQUID, 4, 6));
    }
    ...
    public static void commonSpawns(MobSpawnSettings.Builder p_343832_, int p_345363_) {
        ...
        monsters(p_343832_, 95, 5, 0, p_345363_, false);
    }

    public static void commonSpawnWithZombieHorse(MobSpawnSettings.Builder p_453107_) {
        caveSpawns(p_453107_);
        monsters(p_453107_, 90, 5, 5, 100, false);
    }

    public static void swampSpawns(MobSpawnSettings.Builder p_459267_, int p_453601_) {
        commonSpawns(p_459267_, p_453601_);
        p_459267_.addSpawn(MobCategory.MONSTER, 1, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 1, 1));
        p_459267_.addSpawn(MobCategory.MONSTER, 30, new MobSpawnSettings.SpawnerData(EntityType.BOGGED, 4, 4));
        p_459267_.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.FROG, 2, 5));
    }

    public static void oceanSpawns(MobSpawnSettings.Builder p_126741_, int p_126742_, int p_126743_, int p_126744_) {
        p_126741_.addSpawn(MobCategory.WATER_CREATURE, p_126742_, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 1, p_126743_));
        p_126741_.addSpawn(MobCategory.WATER_AMBIENT, p_126744_, new MobSpawnSettings.SpawnerData(EntityType.COD, 3, 6));
        commonSpawns(p_126741_);
        p_126741_.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 1, 1));
    }

    public static void warmOceanSpawns(MobSpawnSettings.Builder p_126737_, int p_126738_, int p_126739_) {
        p_126737_.addSpawn(MobCategory.WATER_CREATURE, p_126738_, new MobSpawnSettings.SpawnerData(EntityType.SQUID, p_126739_, 4));
        p_126737_.addSpawn(MobCategory.WATER_AMBIENT, 25, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 8, 8));
        p_126737_.addSpawn(MobCategory.WATER_CREATURE, 2, new MobSpawnSettings.SpawnerData(EntityType.DOLPHIN, 1, 2));
        p_126737_.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 1, 1));
        commonSpawns(p_126737_);
    }

    public static void plainsSpawns(MobSpawnSettings.Builder p_126793_) {
        farmAnimals(p_126793_);
        p_126793_.addSpawn(MobCategory.CREATURE, 5, new MobSpawnSettings.SpawnerData(EntityType.HORSE, 2, 6));
        p_126793_.addSpawn(MobCategory.CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityType.DONKEY, 1, 3));
        commonSpawnWithZombieHorse(p_126793_);
    }

    public static void snowySpawns(MobSpawnSettings.Builder p_126797_, boolean p_457060_) {
        p_126797_.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 2, 3));
        p_126797_.addSpawn(MobCategory.CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityType.POLAR_BEAR, 1, 2));
        caveSpawns(p_126797_);
        monsters(p_126797_, p_457060_ ? 90 : 95, 5, p_457060_ ? 5 : 0, 20, false);
        p_126797_.addSpawn(MobCategory.MONSTER, 80, new MobSpawnSettings.SpawnerData(EntityType.STRAY, 4, 4));
    }

    public static void desertSpawns(MobSpawnSettings.Builder p_126801_) {
        p_126801_.addSpawn(MobCategory.CREATURE, 12, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 2, 3));
        p_126801_.addSpawn(MobCategory.CREATURE, 1, new MobSpawnSettings.SpawnerData(EntityType.CAMEL, 1, 1));
        caveSpawns(p_126801_);
        monsters(p_126801_, 19, 1, 0, 50, false);
        p_126801_.addSpawn(MobCategory.MONSTER, 80, new MobSpawnSettings.SpawnerData(EntityType.HUSK, 4, 4));
        p_126801_.addSpawn(MobCategory.MONSTER, 50, new MobSpawnSettings.SpawnerData(EntityType.PARCHED, 4, 4));
    }

    public static void dripstoneCavesSpawns(MobSpawnSettings.Builder p_194734_) {
        caveSpawns(p_194734_);
        int i = 95;
        monsters(p_194734_, 95, 5, 0, 100, false);
        p_194734_.addSpawn(MobCategory.MONSTER, 95, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 4, 4));
    }

    public static void monsters(MobSpawnSettings.Builder p_194726_, int p_194727_, int p_194728_, int p_194729_, int p_450605_, boolean p_194730_) {
        p_194726_.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, p_194727_, new MobSpawnSettings.SpawnerData(p_194730_ ? EntityType.DROWNED : EntityType.ZOMBIE, 4, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, p_194728_, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_VILLAGER, 1, 1));
        if (p_194729_ > 0) {
            p_194726_.addSpawn(MobCategory.MONSTER, p_194729_, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_HORSE, 1, 1));
        }

        p_194726_.addSpawn(MobCategory.MONSTER, p_450605_, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.CREEPER, 4, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 4, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, 10, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 1, 4));
        p_194726_.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1));
    }

    public static void mooshroomSpawns(MobSpawnSettings.Builder p_126805_) {
        p_126805_.addSpawn(MobCategory.CREATURE, 8, new MobSpawnSettings.SpawnerData(EntityType.MOOSHROOM, 4, 8));
        caveSpawns(p_126805_);
    }

    public static void baseJungleSpawns(MobSpawnSettings.Builder p_126809_) {
        farmAnimals(p_126809_);
        p_126809_.addSpawn(MobCategory.CREATURE, 10, new MobSpawnSettings.SpawnerData(EntityType.CHICKEN, 4, 4));
        commonSpawns(p_126809_);
    }

    public static void endSpawns(MobSpawnSettings.Builder p_126813_) {
        p_126813_.addSpawn(MobCategory.MONSTER, 10, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 4, 4));
    }
}