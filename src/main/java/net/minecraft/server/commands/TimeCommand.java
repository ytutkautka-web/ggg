                    ...
                    Commands.literal("query")
                        ...
                        .then(
                            Commands.literal("gametime")
                                .executes(p_449045_ -> queryTime(p_449045_.getSource(), (int)(p_449045_.getSource().getLevel().getGameTime() % 2147483647L)))
                        )
                        .then(
                            Commands.literal("day")
                                .executes(p_449044_ -> queryTime(p_449044_.getSource(), (int)(p_449044_.getSource().getLevel().getDayCount() % 2147483647L)))
                        )
                )
        );
    }
